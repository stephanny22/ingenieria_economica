...
{(variableToCalculate === 'principal' || variableToCalculate === 'rate' || variableToCalculate === 'years') && (
        ...
        <button style={{ backgroundColor: '#FFA500', color: 'white', padding: '10px 20px', border: 'none', borderRadius: '5px', cursor: 'pointer', textAlign: 'center' }} onClick={calculate}>Calcular</button>
        {result !== null && (
