...
<div className="bg-primary shadow-lg rounded-lg overflow-hidden">
    ...
    <div style={{ padding: '50px', maxWidth: '400px', margin: '0 auto' }}>
        <h2 style={{ textShadow: "2px 2px 2px #05d005, -2px -2px 2px #05d005, 2px -2px 2px #05d005, -2px 2px 2px #05d005", textDecoration: "underline", color: 'black', textAlign: 'center',  }}>Calculadora de Interés Simple</h2>
