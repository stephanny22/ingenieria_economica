...
const SimpleInterestCalculator = () => {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '400px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '10px' }}>
        <label>
          ...
          >
            ...
            <option value="years">Tiempo (t) "en días"</option>
            <option value="finalAmount">Capital Final "Monto" (F)</option>
          </select>
        </label>
      </div>
  
      {(variableToCalculate !== 'principal' && variableToCalculate !== 'finalAmount') && (
        <div style={{ marginBottom: '10px' }}>
          <label>
            Principal (C):
            <input
      ...
      {(variableToCalculate !== 'rate' && variableToCalculate !== 'finalAmount') && (
        <div style={{ marginBottom: '10px' }}>
          <label>
            Tasa de Interés (i) %:
            <input
      ...
      {(variableToCalculate !== 'years' && variableToCalculate !== 'finalAmount') && (
        <div style={{ marginBottom: '10px' }}>
          <label>
            Tiempo (t):
            <input
      ...
      {(variableToCalculate === 'interest' || variableToCalculate === 'finalAmount') && (
        <div style={{ marginBottom: '10px' }}>
          <label>
            Interés (I):
            <input
