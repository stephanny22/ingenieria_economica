...
<div className="bg-primary shadow-lg rounded-lg overflow-hidden">
    ...
    <div style={{ padding: '50px', maxWidth: '400px', margin: '0 auto' }}>
        <h2 style={{ textShadow: "2px 2px 2px #05d005, -2px -2px 2px #05d005, 2px -2px 2px #05d005, -2px 2px 2px #05d005", textDecoration: "underline", color: '#00ff00', textAlign: 'center',  }}>Calculadora de Interés Simple</h2>
...
{(variableToCalculate === 'principal' || variableToCalculate === 'rate' || variableToCalculate === 'years') && (
        ...
        <button style={{ backgroundColor: '#FFA500', color: 'white', padding: '10px 20px', border: 'none', borderRadius: '5px', cursor: 'pointer' }} onClick={calculate}>Calcular</button>
        {result !== null && (
