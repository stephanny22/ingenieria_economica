...
const SimpleInterestCalculator = () => {
  ...
  <div style={{ padding: '20px', maxWidth: '400px', margin: '0 auto' }}>
    ...
    {(variableToCalculate !== 'principal' || variableToCalculate === 'rate' || variableToCalculate === 'years' || variableToCalculate === 'finalAmount') && (
      <div style={{ marginBottom: '10px' }}>
        <label>
          Principal (C):
          <input
    ...
    {(variableToCalculate === 'principal' || variableToCalculate === 'rate' || variableToCalculate === 'finalAmount' || variableToCalculate === 'years') && (
      <div style={{ marginBottom: '10px' }}>
        <label>
          Tasa de Interés (i) %:
          <input
