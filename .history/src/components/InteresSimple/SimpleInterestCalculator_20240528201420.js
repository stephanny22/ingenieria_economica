...
const SimpleInterestCalculator = () => {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '400px', margin: '0 auto' }}>
      ...
      {(variableToCalculate !== 'principal' || variableToCalculate === 'rate') && (
        <div style={{ marginBottom: '10px' }}>
          <label>
            Principal (C):
            <input
      ...
      {(variableToCalculate === 'principal' || variableToCalculate === 'rate' || variableToCalculate === 'finalAmount') && (
        <div style={{ marginBottom: '10px' }}>
          <label>
