...
export const HomePage = () => {
  ...
  return (
    <div className="flex flex-wrap h-full" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
