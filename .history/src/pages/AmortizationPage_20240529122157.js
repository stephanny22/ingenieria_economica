...
export const AnnuitiesPage = () => {
  ...
  return (
    ...
    >
      <div className="bg-primary shadow-lg rounded-lg overflow-hidden" style={{ maxWidth: '1200px', margin: '0 auto', padding: '30px' }}>
        <h2
          className="text-center text-white"
          style={{
            textShadow:
              "2px 2px 2px #d400ff, -2px -2px 2px #d400ff, 2px -2px 2px #d400ff, -2px 2px 2px #d400ff",
          }}
        >
          Anualidades
        </h2>
