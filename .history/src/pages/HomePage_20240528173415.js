...
export const HomePage = () => {
  const members = [
    { name: "Stephanny Guevara", imageUrl: require('../assets/persona-soltera.png') },
    { name: "Miguel Angel Barrera", imageUrl: require('../assets/persona-soltera.png') },
    { name: "Nicol Valentina Barajas", imageUrl: require('../assets/persona-soltera.png') },
    { name: "Claudia Elena Sanchez", imageUrl: require('../assets/persona-soltera.png') },
  ];
  return (
