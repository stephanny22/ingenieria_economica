...
export const HomePage = () => {
  const members = [
    { name: "Stephanny Guevara", useHref: "../assets/persona-soltera.png" },
    { name: "Miguel Angel Barrera", useHref: "../assets/persona-soltera.png" },
    { name: "Nicol Valentina Barajas", useHref: "../assets/persona-soltera.png" },
    { name: "Claudia Elena Sanchez", useHref: "../assets/persona-soltera.png" },
  ];
