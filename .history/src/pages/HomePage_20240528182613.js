...
export const HomePage = () => {
  ...
  <span className="block text-3xl font-bold mb-3 text-white" style={{ textShadow: "2px 2px 2px #FFA500, -2px -2px 2px #FFA500, 2px -2px 2px #FFA500, -2px 2px 2px #FFA500" }}>INTEGRANTES</span>
</div>
