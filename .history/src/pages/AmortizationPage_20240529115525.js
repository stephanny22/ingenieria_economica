...
import {
  AmortizacionAnnuity, // Asegúrate de importar el componente AmortizationAnnuity
          ...
          <div className="col-md-9 order-2 order-md-1">
            ...
            {watch("tipoOperacion") &&
              watch("tipoOperacion") !== "anualidad" && (
                <AmortizationAnnuity register={register} errors={errors} /> // Aquí se utiliza AmortizationAnnuity
              )}
            <button
              type="submit"
