...
export const HomePage = () => {
  ...
  return (
    <div className="flex flex-wrap h-cover" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
