...
import backgroundImage from '../../components/Home/2323766.jpg'; // Importa la imagen
...
export const HomePage = () => {
  ...
  return (
    <div className="flex flex-wrap" style={{ backgroundImage: 'url("../components/Home/2323766.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
