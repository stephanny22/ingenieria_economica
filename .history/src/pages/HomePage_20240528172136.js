...
export const HomePage = () => {
  const members = [
    { name: "Stephanny Guevara", imageUrl: generateImageUrl("Stephanny Guevara") },
    { name: "Miguel Angel Barrera", imageUrl: generateImageUrl("Miguel Angel Barrera") },
    { name: "Nicol Valentina Barajas", imageUrl: generateImageUrl("Nicol Valentina Barajas") },
    { name: "Claudia Elena Sanchez", imageUrl: generateImageUrl("Claudia Elena Sanchez") },
  ];
