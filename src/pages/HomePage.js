  ...
  return (
    <div className="flex flex-wrap" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', minHeight: '100vh'}}>
      <div className="w-full h-0 p-5 text-center">
        <span className="block text-3xl font-bold mb-3 text-white lato-regular" style={{ textShadow: "2px 2px 2px #FFA500, -2px -2px 2px #FFA500, 2px -2px 2px #FFA500, -2px 2px 2px #FFA500", textDecoration: "underline" }}>
          MIEMBROS
        </span>
      </div>
