export const AmortizationPeriod = ({ register, errors, watch }) => {
  return (
    <>
        ...
        <div className="row">
          {watch("tipoOperacion") !== "periodo" && (
            <div>
              ...
              <input
                ...
                placeholder="Digite la cantidad de periodos"
                min="1"
                {...register("periodo", {
                  valueAsNumber: true,
                  required: "El número de periodos es obligatorio.",
                  min: {
                    value: 1,
                    message: "El número de periodos debe ser mayor o igual a 1.",
                  },
                })}
              />
              {errors.periodo && (
          ...
          <label>Capitalización de la tasa de interés</label>
            ...
            {errors.periodo_tiempo && (
              <div className="invalid-feedback">{errors.periodo_tiempo.message}</div>
            )}
          </div>
        </div>
      </div>
